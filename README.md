...
- Added a static privacy policy page (`public/privacy.html`, deployed at `/privacy.html`) for the Play Store / App Store submission flows, since both apps request location and (mobile-only) notification permissions
